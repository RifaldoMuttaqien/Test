...
class Admin_control extends MS_Controller {
    ...
    public function create_exam()
    {
        ...
        if ($this->input->post()) {
            ...
            $this->form_validation->set_rules('retake_allowed', 'Retake Allowed', 'required|integer');
    ...
    public function get_courses_ajax($category)
    {
        $courses = $this->course_model->get_courses_by_cat_id($category);
        $str = '';
        foreach ($courses as $value) {
            $str.='<option value="'.$value->course_id.'">'.$value->course_title.'</option>';
        }
