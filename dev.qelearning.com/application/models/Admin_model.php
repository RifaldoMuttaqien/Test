...
class Admin_model extends CI_Model
{
   ...
   public function get_mock_detail($id)
    ...
    public function add_mock_title($upload_data = '')
    {
        ...
        $info['retake_allowed'] = $this->input->post('retake_allowed', TRUE);
        $info['student_can_see_result'] = $this->input->post('student_can_see_result', TRUE);
        $info['student_can_see_ans_key'] = $this->input->post('student_can_see_ans_key', TRUE);
