            ...
            <div class="row">
                ...
                <div class="col-md-10 col-sm-12 col-md-offset-1 col-sm-offset-0">
                    ...
                    if ($this->session->userdata('log')) {
                        ...
                        $retake = $this->db->where('user_id', $this->session->userdata('user_id'))->where('exam_id', $mock->title_id)->get('user_exam')->row();
                        if($retake && $retake->retake_count >= $mock->retake_allowed){
                        ?>
                            <div class="alert alert-danger">
                                You can't take this exam again.
                            </div>
                        <?php
                        }
                        else{
