               ...
               if (($user->active == 1) && ($user->banned == 0) && ($user->user_role_id == 5)) { ?>
                <tr class="<?=($i & 1) ? 'even' : 'odd'; ?>">
                    ...
                    <div class="btn-group">
                        ...
                        <a class="btn btn-default btn-xs" href = "<?=base_url('index.php/user_control/assigned_courses/' .$user->user_id);?>"><i class="glyphicon glyphicon-book"></i><span class="invisible-on-xs"> Courses</span></a>

                        <a class="btn btn-default btn-xs" href = "<?=base_url('index.php/user_control/modify_user/' .$user->user_id);?>"><i class="glyphicon glyphicon-edit"></i><span class="invisible-on-xs">  Modify</span></a>

                        <a onclick="return ban_confirmation('<?=$user->user_name?>')"  class="btn btn-default btn-xs" href = "<?=base_url('index.php/user_control/ban_user_account/' . $user->user_id); ?>"><i class="glyphicon glyphicon-ban-circle"></i><span class="invisible-on-md">  Ban</span></a>

                        <a onclick="return delete_confirmation('<?=$user->user_name?>')" href = "<?php echo base_url('index.php/user_control/delete_user_account/' . $user->user_id); ?>" class="btn btn-xs btn-default"><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-md">  Delete</span></a>
