            ...
            <div class="form-group">
                ...
                <div class="col-sm-3 col-xs-6 col-mb">
                    <select name="public" class="form-control">
                        <option value="1" <?=(1 == $courses->public)?'selected':'';?> >Yes</option>
                        <option value="0" <?=(0 == $courses->public)?'selected':'';?> >No</option>
                    </select>
                </div>
                <p class="help-block info"><strong><i class="glyphicon glyphicon-warning-sign"></i> If No, This course will only available for the students who assigned to this course.  </strong></p>
            </div>
            <div class="form-group">
