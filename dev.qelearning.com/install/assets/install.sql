...
CREATE TABLE `exam_title` (
  ...
  `category_id` int(5) NOT NULL,
  `student_can_see_result` tinyint(1) NOT NULL DEFAULT '1',
  `student_can_see_ans_key` int(5) DEFAULT NULL,
  `retake_allowed` int(5) DEFAULT NULL,
...
CREATE TABLE `user_exam` (
  ...
  `retake_count` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`)
