...
class User_model extends CI_Model
{
    ...
    {
       return $this->db->where('user_role_id', 5)
            ->get('users')
            ->result();
    }
    ...
    {
        $result = $this->db->select('user_course.course_id,user_course.last_download,courses.course_title,courses.course_id,sub_categories.sub_cat_name,categories.category_name')
                ->where('user_id', $user)
                ->from('user_course')
