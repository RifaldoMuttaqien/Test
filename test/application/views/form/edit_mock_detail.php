...
<div class="block">
    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="form-group">
                <label for="retake_allowed" class="col-sm-offset-0 col-lg-3 col-xs-offset-1 col-xs-3 control-label mobile">Retake allowed</label>
                <div class="col-sm-2 col-md-3 col-xs-6 col-mb">
                    <input type="number" name="retake_allowed" value="<?=$mock->retake_allowed; ?>" class="form-control" placeholder="" required>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2 col-md-3 col-xs-6 col-mb">
                    <select name="student_can_see_result" class="form-control">
                        <option value="1" <?=(1 == $mock->student_can_see_result)?'selected':'';?> >Yes</option>
                        <option value="0" <?=(0 == $mock->student_can_see_result)?'selected':'';?> >No</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-2 col-md-3 col-xs-6 col-mb">
                    <select name="student_can_see_ans_key" class="form-control">
                        <option value="1" <?=(1 == $mock->student_can_see_ans_key)?'selected':'';?> >Yes</option>
                        <option value="0" <?=(0 == $mock->student_can_see_ans_key)?'selected':'';?> >No</option>
                    </select>
                </div>
            </div>
